...
/** Asset system model */
export type AssetIconProjectArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']['input']>;
...
export type AssetManyWhereInput = {
  ...
  iconProject_every?: InputMaybe<ProjectWhereInput>;
  iconProject_none?: InputMaybe<ProjectWhereInput>;
  iconProject_some?: InputMaybe<ProjectWhereInput>;
...
export type CertificationManyWhereInput = {
  ...
  /** All values that are not contained in given list. */
  credentialId_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
...
export type EducationManyWhereInput = {
  ...
  achievements_contains_all?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  achievements_contains_none?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  achievements_contains_some?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  achievements_not?: InputMaybe<Array<Scalars['String']['input']>>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
  ...
  specialization?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  specialization_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
  specialization_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  specialization_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  specialization_not?: InputMaybe<Scalars['String']['input']>;
  /** All values not containing the given string. */
  specialization_not_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values not ending with the given string */
  specialization_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  specialization_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  specialization_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  specialization_starts_with?: InputMaybe<Scalars['String']['input']>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
...
export type Experience = Entity & Node & {
  ...
  /** The unique identifier */
  id: Scalars['ID']['output'];
  jobTitile?: Maybe<Scalars['String']['output']>;
...
export type ExperienceCreateInput = {
  ...
  companyLogo?: InputMaybe<AssetCreateOneInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
...
export type ExperienceManyWhereInput = {
  ...
  description?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array contains *all* items provided to the filter */
  description_contains_all?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  description_contains_none?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  description_contains_some?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  ...
  jobTitile?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  jobTitile_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
  jobTitile_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  jobTitile_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  jobTitile_not?: InputMaybe<Scalars['String']['input']>;
  /** All values not containing the given string. */
  jobTitile_not_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values not ending with the given string */
  jobTitile_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  jobTitile_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  jobTitile_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  jobTitile_starts_with?: InputMaybe<Scalars['String']['input']>;
  location?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
...
export enum ExperienceOrderByInput {
  ...
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  JobTitileAsc = 'jobTitile_ASC',
  JobTitileDesc = 'jobTitile_DESC',
...
export type ProfileManyWhereInput = {
  ...
  /** All values ending with the given string. */
  aboutMe_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  ...
  /** All values not ending with the given string */
  aboutMe_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  aboutMe_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  aboutMe_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  aboutMe_starts_with?: InputMaybe<Scalars['String']['input']>;
...
export type ScheduledOperationAffectedDocument = Asset | Certification | Education | Experience | Profile | Project | Publication | Skill;
...
export type CertificationsQuery = { __typename?: 'Query', certifications: Array<{ __typename?: 'Certification', id: string, name?: string | null, issuer?: string | null, date?: any | null, credentialId?: string | null, link?: string | null }> };

export type EducationQueryVariables = Exact<{ [key: string]: never; }>;


export type EducationQuery = { __typename?: 'Query', educations: Array<{ __typename?: 'Education', id: string, period?: string | null, degree?: string | null, institution?: string | null, achievements: Array<string>, specialization?: string | null }> };

export type ExperiencesQueryVariables = Exact<{ [key: string]: never; }>;


export type ExperiencesQuery = { __typename?: 'Query', experiences: Array<{ __typename?: 'Experience', id: string, company?: string | null, startDate?: any | null, endDate?: any | null, jobTitile?: string | null, location?: string | null, description: Array<string>, companyLogo?: { __typename?: 'Asset', url: string, id: string } | null, skills: Array<{ __typename?: 'Skill', name: string }> }> };
...
export type ProjectQuery = { __typename?: 'Query', projects: Array<{ __typename?: 'Project', id: string, name: string, description?: string | null, website?: string | null, githubLink?: string | null, skills: Array<{ __typename?: 'Skill', name: string }>, icon?: { __typename?: 'Asset', url: string } | null }> };
...
export const ResumeDocument = gql`
  ...
  skills(first: 200, orderBy: order_ASC, where: {showOnCv: true}) {
    name
    type
  }
  experiences(orderBy: startDate_DESC) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Certifications(variables?: CertificationsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<CertificationsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CertificationsQuery>({ document: CertificationsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'Certifications', 'query', variables);
    },
    Education(variables?: EducationQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<EducationQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<EducationQuery>({ document: EducationDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'Education', 'query', variables);
    },
    Experiences(variables?: ExperiencesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<ExperiencesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ExperiencesQuery>({ document: ExperiencesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'Experiences', 'query', variables);
    },
    ...
    Publications(variables?: PublicationsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<PublicationsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<PublicationsQuery>({ document: PublicationsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'Publications', 'query', variables);
    },
    ...
    SkillTypes(variables?: SkillTypesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SkillTypesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SkillTypesQuery>({ document: SkillTypesDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'SkillTypes', 'query', variables);
    },
    Skills(variables?: SkillsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<SkillsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SkillsQuery>({ document: SkillsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'Skills', 'query', variables);
    }
  };
}
